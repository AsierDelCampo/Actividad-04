...
('Grapadora met�lica', 20.30, 97, 5),
('L�pices Staedtler', 2.00, 59, 2),
('Portal�pices con reloj', 10.00, 66, 3),
('Portal�pices serigrafiado', 6.00, 31, 3),
('Post-it colores', 3.00, 80, 1),
('Post-it �nico color', 2.50, 55, 1),
('Sobres 90 G/M2', 2.50, 71, 1),
('Subrayador de colores', 9.00, 43, 1),
('Subrayador �nico color', 2.20, 90, 1),
...
('ALEX c�moda con 9 cajones', 106.61, 25, 6),
('Cubo pedal 40 litros CURVER CROMADO MATE', 25.57, 70, 6),
('Estanter�a de resina ELEGANCE NEGRO 138 X 60 X 30', 10.70, 34, 6),
('M-CAJONERA', 66.00, 49, 6),
('MESAS DE DIRECCI�N H2 DE HERPESA', 147.00, 19, 6),
('Nespresso De Longhi INISSIA', 61.61, 11, 8),
('Pantalla con tr�pode FONESTAR', 128.09, 38, 4),
...
('L�MPARA FLEXO PLATEADO', 12.50, 52, 7);
